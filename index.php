                    ...
                    <fieldset>
                        ...
                        <div style="display: flex; justify-content: space-between;">
                            <div class="form-group" style="width: 100%;">
                                <label for="cartao">Número do cartão: <span class="obrigatorio">*</span></label>
                                <input type="text" class="form-control" id="cartao" name="cartao" maxlength="50" style="display: flex; flex: 1;" value="6298690101272146">
                            </div>
                        </div>
                    </fieldset>
                </div>
