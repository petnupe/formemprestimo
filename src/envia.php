...
$mail = new sendMail(array('peterson@tecbiz.com.br', 'credenciamento@tecbiz.com.br', 'oseias@tecbiz.com.br'), 'Formulário de empréstimo', $mensagem, null, null, $rg, null, true, false, true, $compResidencia);
