...
function validarCartao() {
	...
	var regex = /^6298 69/;
	if ($("#cartao").val().length != 19 || !regex.test($("#cartao").val())) erroHTML += "<li>N&uacute;mero de Cart&atilde;o inv&aacute;lido!</li>";
...
function validar() {
	...
	if ($("#nome_completo").val().length < 3) erroHTML += "<li>Nome inv&aacute;lido!</li>";

	if (!validaCPF(filtra_caracteres_nao_numericos($("#cpf").val()))) erroHTML += "<li>CPF inv&aacute;lido!</li>";
	...
	if ($("#naturalidade").val().length < 3) erroHTML += "<li>Naturalidade inv&aacute;lida!</li>";

	if ($("#estado_civil").val().length < 3) erroHTML += "<li>Estado Civil inv&aacute;lido!</li>";

	if (!validarEmail($("#email").val())) erroHTML += "<li>Email inv&aacute;lido!</li>";
	...
	if ($("#rua").val().length < 3) erroHTML += "<li>Rua inv&aacute;lida!</li>";

	if ($("#numero").val().length < 0) erroHTML += "<li>N&uacute;mero inv&aacute;lido!</li>";

	if ($("#cep").val().length < 9) erroHTML += "<li>CEP inv&aacute;lido!</li>";

	if ($("#bairro").val().length < 3) erroHTML += "<li>Bairro inv&aacute;lido!</li>";

	if ($("#uf").val().length < 2) erroHTML += "<li>UF inv&aacute;lido!</li>";

	if ($("#cidade").val().length < 3) erroHTML += "<li>Cidade inv&aacute;lida!</li>";
